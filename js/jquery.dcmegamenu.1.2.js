				...
				$('> li',$dcMegaMenuObj).each(function(){
					...
					if($(mainSub).length > 0){
						...
						if($('ul',mainSub).length > 0){
							...
							totalWidth = $(mainSub).parent('.sub-container').outerWidth(true);
							var marginLeft = (totalItemWidth - parentWidth)/2;
							var subLeft = parentLeft - marginLeft;
							var marginRight = menuWidth - parentLeft - totalItemWidth;
							// If Left Position Is Negative Set To Left Margin
							if(marginRight < 0){
								$('.sub-container',this).css('right','0');
							} else {
								$('.sub-container',this).css('left',parentLeft+'px');
							}
							...
							//sub-container top border for ie
							var $subContainer = $('.sub-container',this);
							$('<div class="ie-top-border" />').appendTo($subContainer)
								.css({
									'width': totalWidth - $(this).width(),
